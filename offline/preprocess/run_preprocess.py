...
def convert(force: bool) -> None:
    from offline.preprocess.convert_to_parquet import convert_raw_to_parquet

    convert_raw_to_parquet(force=force)


def audit(force: bool) -> None:
    from offline.preprocess.audit_raw_files import audit_raw_files

    audit_raw_files(force=force)


def master(force: bool) -> None:
    from offline.preprocess.build_master_tables import build_master_tables
...
def inject(force: bool) -> None:
    ...
    if not spec_path.exists():
        ...
        return
    from offline.utils.synthetic_injector import SyntheticInjector
...
def feat(force: bool) -> None:
    from offline.preprocess.feature_engineering import feature_engineering
