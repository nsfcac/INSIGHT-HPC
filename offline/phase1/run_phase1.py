...
def threshold(force: bool) -> None:
    from offline.phase1.baseline_threshold import run_baseline_threshold

    run_baseline_threshold(force=force)


def iforest(force: bool) -> None:
    from offline.phase1.isolation_forest import run_isolation_forest

    run_isolation_forest(force=force)


def lstm(force: bool) -> None:
    from offline.phase1.lstm_autoencoder import run_lstm_autoencoder

    run_lstm_autoencoder(force=force)


def baseline(force: bool) -> None:
    from offline.phase1.baseline_comparison import run_baseline_comparison

    run_baseline_comparison(force=force)


def evaluate(force: bool) -> None:
    from offline.phase1.evaluate import run_evaluation
