...
from src.phase4.operator_alert_module.master import build_master_ctx
from src.phase4.operator_alert_module.phase import (
    phase_label_short,
    phase_supporting_text,
)
from src.phase4.operator_alert_module.rules import infer_rack, jobs_clause
from src.phase4.operator_alert_module.summary import (
    format_duration,
    format_lead_time,
    format_section,
