...
from src.utils.io_utils import bool_series, load_config, save_parquet
from src.phase4.score_fusion_module.loaders import (
...
def run_fused_table(force: bool = False) -> pd.DataFrame:
    ...
    phase3_dir = Path(cfg.get("phase3", {}).get("output_dir", "data/phase3"))
    out_dir = Path(cfg["phase4"].get("output_dir", "data/phase4"))
