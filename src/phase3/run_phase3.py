...
from src.utils.phase_runner import add_common_args, run_stages
...
def run_physics_stage(force: bool) -> None:
    from src.phase3.physics_models import run_physics_models

    run_physics_models(force=force)


def run_constraints_stage(force: bool) -> None:
    from src.phase3.physics_constraints import run_physics_constraints

    run_physics_constraints(force=force)


def run_job_context_stage(force: bool) -> None:
    from src.phase3.job_context_annotator import run_job_context_annotator
