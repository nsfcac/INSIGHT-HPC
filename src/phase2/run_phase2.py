...
def segment(force: bool) -> None:
    from src.phase2.segment_jobs import run_segment_jobs

    run_segment_jobs(force=force)


def profiles(force: bool) -> None:
    from src.phase2.profiling_and_clustering import run_build_profiles

    run_build_profiles(force=force)


def cluster(force: bool) -> None:
    from src.phase2.profiling_and_clustering import run_cluster_jobs

    run_cluster_jobs(force=force)


def train(force: bool) -> None:
    from src.phase2.profiling_and_clustering import run_train_cluster_models

    run_train_cluster_models(force=force)


def attribute(force: bool) -> None:
    from src.phase2.attribute_alerts import run_attribute_alerts

    run_attribute_alerts(force=force)


def multi(force: bool) -> None:
    from src.phase2.coherence import run_multi_node_coherence

    run_multi_node_coherence(force=force)


def coh_pm(force: bool) -> None:
    from src.phase2.coherence import run_per_minute_coherence

    run_per_minute_coherence(force=force)


def streaming(force: bool) -> None:
    from src.phase2.coherence import run_streaming_coherence
